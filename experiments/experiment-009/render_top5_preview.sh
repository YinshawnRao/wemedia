...
RAW_DIR="${ROOT_DIR}/sandbox/yt-dlp/clips/experiment-009"
PROJECT_DIR="${ROOT_DIR}/sandbox/hyperframes/experiment-009"
ASSET_DIR="${PROJECT_DIR}/assets"
OUT_DIR="${ROOT_DIR}/sandbox/exports/experiment-009"
WORK_DIR="${OUT_DIR}/ffmpeg_top5_work"
FINAL_OUT="${OUT_DIR}/rainie-top5-vocal-difficulty-preview.mp4"
CONTACT_SHEET="${OUT_DIR}/rainie-top5-vocal-difficulty-contact-sheet.jpg"
...
<svg xmlns="http://www.w3.org/2000/svg" width="1080" height="1920" viewBox="0 0 1080 1920">
  ...
  <rect x="54" y="76" width="520" height="76" fill="#0e1116" opacity="0.78"/>
...
process_asset "anurOHpo0aY" "01-nianlunshuo"
process_asset "KOLDiXnQC7Q" "02-daiwozou"
process_asset "oec9R5ypf-o" "03-yuai"
process_asset "s9hGDIpwfXw" "04-nimingdehaoyou"
process_asset "mebzXfWi87E" "05-aimei"

make_title_overlay "00-intro" "RAINIE YANG / VOCAL DIFFICULTY TOP 5" "杨丞琳歌曲" "演唱难度 TOP5" "每段取高音/高难度片段，配音乐科普备注。"
render_title_segment "00-intro" "5.0" "${WORK_DIR}/segments/00-intro.mp4"

make_rank_overlay "01-nianlunshuo" "#e94b35" "TOP 1 / 高位细密" "年轮说" "参考峰值：B4-C#5 区间" "难点：高位长句 + 弱强转换" "科普：这类歌难在不喊，声音还要一圈圈推上去。" "杨丞琳官方频道 / 年轮说 Official HD MV"
render_overlay_segment "${ASSET_DIR}/01-nianlunshuo.mp4" "01-nianlunshuo" "${WORK_DIR}/segments/01-nianlunshuo.mp4"

make_rank_overlay "02-daiwozou" "#f2c14e" "TOP 2 / 尾段爆发" "带我走" "参考峰值：B4-C5 区间" "难点：尾段副歌 + 长线支撑" "科普：高音不只是一瞬间，连续副歌最考验体力。" "杨丞琳官方频道 / 带我走 Official MV"
render_overlay_segment "${ASSET_DIR}/02-daiwozou.mp4" "02-daiwozou" "${WORK_DIR}/segments/02-daiwozou.mp4"

make_rank_overlay "03-yuai" "#2bb3a3" "TOP 3 / 哭腔稳定" "雨爱" "参考峰值：A4-B4 区间" "难点：连续副歌 + 气息控制" "科普：哭腔好听，但如果支撑松掉，音准会先飘。" "杨丞琳官方频道 / 雨爱 Official MV"
render_overlay_segment "${ASSET_DIR}/03-yuai.mp4" "03-yuai" "${WORK_DIR}/segments/03-yuai.mp4"

make_rank_overlay "04-nimingdehaoyou" "#9ccfd8" "TOP 4 / 强弱边缘" "匿名的好友" "参考峰值：A4-B4 区间" "难点：真假声边缘 + 叙事张力" "科普：轻到强的转折，最怕声音断层或情绪过满。" "杨丞琳官方频道 / 匿名的好友 Official MV"
render_overlay_segment "${ASSET_DIR}/04-nimingdehaoyou.mp4" "04-nimingdehaoyou" "${WORK_DIR}/segments/04-nimingdehaoyou.mp4"

make_rank_overlay "05-aimei" "#f7f2e8" "TOP 5 / 轻声难稳" "暧昧" "参考峰值：G#4-A#4 区间" "难点：轻声位置 + 气声控制" "科普：看似不炸裂，但越轻越需要气息和音准稳定。" "杨丞琳官方频道 / 暧昧 Official MV"
render_overlay_segment "${ASSET_DIR}/05-aimei.mp4" "05-aimei" "${WORK_DIR}/segments/05-aimei.mp4"

make_title_overlay "99-closing" "REFERENCE ONLY" "难唱不等于越高越好" "稳、轻、准也很难" "后续可做：现场版对比 / 逐句扒谱 / KTV难度版。"
...
file '${WORK_DIR}/segments/01-nianlunshuo.mp4'
file '${WORK_DIR}/segments/02-daiwozou.mp4'
file '${WORK_DIR}/segments/03-yuai.mp4'
file '${WORK_DIR}/segments/04-nimingdehaoyou.mp4'
file '${WORK_DIR}/segments/05-aimei.mp4'
