...
RAW_DIR="${ROOT_DIR}/sandbox/yt-dlp/clips/experiment-013"
PROJECT_DIR="${ROOT_DIR}/sandbox/hyperframes/experiment-013"
ASSET_DIR="${PROJECT_DIR}/assets"
OUT_DIR="${ROOT_DIR}/sandbox/exports/experiment-013"
WORK_DIR="${OUT_DIR}/ffmpeg_tao_top5_work"
FINAL_OUT="${OUT_DIR}/david-tao-top5-vocal-difficulty-preview.mp4"
CONTACT_SHEET="${OUT_DIR}/david-tao-top5-vocal-difficulty-contact-sheet.jpg"
...
<svg xmlns="http://www.w3.org/2000/svg" width="1080" height="1920" viewBox="0 0 1080 1920">
  ...
  <rect x="54" y="76" width="600" height="76" fill="#0e1116" opacity="0.78"/>
...
make_contact_sheet() {
  ...
  mkdir -p "$frames_dir"
  local idx=0
  for t in 2 25 82 145 200 252 272; do
...
process_asset "vqgR5lOeKnY" "01-top5-spring-wind" "49.2"
process_asset "bkiNoPR1qls" "02-top4-do-i-do-i" "63.2"
process_asset "GurozK-HRTw" "03-top3-airport-1030" "51.2"
process_asset "UotQ0khBcz8" "04-top2-whats-love" "55.2"
process_asset "dLRaz_y4Vu4" "05-top1-forever" "41.2"

make_title_overlay "00-intro" "DAVID TAO / VOCAL DIFFICULTY TOP 5" "陶喆难度最高" "5首歌" "按你的排名，从 Top5 到 Top1 揭晓。" "本地实验预览：取每首最高音或最高难度段落。"
render_title_segment "00-intro" "5.0" "${WORK_DIR}/segments/00-intro.mp4"

make_rank_overlay "01-top5-spring-wind" "#9ccfd8" "TOP 5 / 爵士韵味" "望春风" "参考难点：爵士编曲 + 密集转音" "音准、语感、气息细节都要稳。" "难在唱出松弛感，不只是唱准。" "Timeless Music / Official MV"
render_overlay_segment "${ASSET_DIR}/01-top5-spring-wind.mp4" "01-top5-spring-wind" "${WORK_DIR}/segments/01-top5-spring-wind.mp4"

make_rank_overlay "02-top4-do-i-do-i" "#2bb3a3" "TOP 4 / 后段强混" "心乱飞" "参考难点：连续强混高音" "后半段咬字紧绷，输出时间长。" "一掉气息，整段就容易破。" "陶喆 David Tao / Official audio"
render_overlay_segment "${ASSET_DIR}/02-top4-do-i-do-i.mp4" "02-top4-do-i-do-i" "${WORK_DIR}/segments/02-top4-do-i-do-i.mp4"

make_rank_overlay "03-top3-airport-1030" "#f2c14e" "TOP 3 / R&B天花板" "飞机场的10:30" "参考难点：真假声极速切换" "密集转音要卡住节奏和律动。" "R&B 味道和音准都不能松。" "Timeless Music / Official MV"
render_overlay_segment "${ASSET_DIR}/03-top3-airport-1030.mp4" "03-top3-airport-1030" "${WORK_DIR}/segments/03-top3-airport-1030.mp4"

make_rank_overlay "04-top2-whats-love" "#e94b35" "TOP 2 / 全程高能" "爱是个什么东西" "参考难点：持续高音 + 刁钻转音" "怪律动里还要稳住气息。" "开篇到尾段几乎不给缓冲。" "Timeless Music / Official MV"
render_overlay_segment "${ASSET_DIR}/04-top2-whats-love.mp4" "04-top2-whats-love" "${WORK_DIR}/segments/04-top2-whats-love.mp4"

make_rank_overlay "05-top1-forever" "#f7f2e8" "TOP 1 / 公认最难" "不爱" "参考难点：持续 High C 强咬字" "音域跨度大，气息和声带负荷拉满。" "极少现场唱，难度标签很硬。" "陶喆 David Tao / Official audio (Forever)"
render_overlay_segment "${ASSET_DIR}/05-top1-forever.mp4" "05-top1-forever" "${WORK_DIR}/segments/05-top1-forever.mp4"

make_title_overlay "99-closing" "RANKING BY USER" "不是飙高音" "是整段扛住" "陶喆的难，常常藏在律动、转音和咬字里。" "下一版可逐句扒谱，核对最高音与换声点。"
...
file '${WORK_DIR}/segments/01-top5-spring-wind.mp4'
file '${WORK_DIR}/segments/02-top4-do-i-do-i.mp4'
file '${WORK_DIR}/segments/03-top3-airport-1030.mp4'
file '${WORK_DIR}/segments/04-top2-whats-love.mp4'
file '${WORK_DIR}/segments/05-top1-forever.mp4'
