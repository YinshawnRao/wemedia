...
RAW_DIR="${ROOT_DIR}/sandbox/yt-dlp/clips/experiment-008"
PROJECT_DIR="${ROOT_DIR}/sandbox/hyperframes/experiment-008"
ASSET_DIR="${PROJECT_DIR}/assets"
OUT_DIR="${ROOT_DIR}/sandbox/exports/experiment-008"
WORK_DIR="${OUT_DIR}/ffmpeg_top5_work"
FINAL_OUT="${OUT_DIR}/angela-top5-vocal-difficulty-preview.mp4"
CONTACT_SHEET="${OUT_DIR}/angela-top5-vocal-difficulty-contact-sheet.jpg"
...
<svg xmlns="http://www.w3.org/2000/svg" width="1080" height="1920" viewBox="0 0 1080 1920">
  ...
  <rect x="54" y="76" width="476" height="76" fill="#0e1116" opacity="0.78"/>
...
process_asset "Oq3dVBEdc4M" "01-adiao"
process_asset "zXHqzoroAj4" "02-butong"
process_asset "UU4p0eb0IBQ" "03-nahan"
process_asset "-4eJy_cpvoo" "04-yuyan"
process_asset "dmwJaG-R1iM" "05-aurora"

make_title_overlay "00-intro" "ANGELA ZHANG / VOCAL DIFFICULTY TOP 5" "张韶涵歌曲" "演唱难度 TOP5" "每段取高音/高难度片段，配音乐科普备注。"
render_title_segment "00-intro" "5.0" "${WORK_DIR}/segments/00-intro.mp4"

make_rank_overlay "01-adiao" "#e94b35" "TOP 1 / 现场高压" "阿刁" "参考峰值：C#6-D6 区间" "难点：高位置强混声 + 长线控制" "科普：超过 C6 后，闭合、支撑和情绪都会被放大。" "芒果TV音乐 / Singer 2018"
render_overlay_segment "${ASSET_DIR}/01-adiao.mp4" "01-adiao" "${WORK_DIR}/segments/01-adiao.mp4"

make_rank_overlay "02-butong" "#f2c14e" "TOP 2 / 副歌极限" "不痛" "参考峰值：B5-C6 区间" "难点：副歌连续上行 + 强弱转换" "科普：B5 以上已经进入女声高难混声区。" "福茂唱片 / 不痛 Official MV"
render_overlay_segment "${ASSET_DIR}/02-butong.mp4" "02-butong" "${WORK_DIR}/segments/02-butong.mp4"

make_rank_overlay "03-nahan" "#2bb3a3" "TOP 3 / 爆发密度" "呐喊" "参考峰值：B5 附近" "难点：高位咬字 + 声压维持" "科普：难点不只在最高音，还在连续爆发不掉位置。" "福茂唱片 / 呐喊 Official MV"
render_overlay_segment "${ASSET_DIR}/03-nahan.mp4" "03-nahan" "${WORK_DIR}/segments/03-nahan.mp4"

make_rank_overlay "04-yuyan" "#9ccfd8" "TOP 4 / 快歌高位" "寓言" "参考峰值：A5-Bb5 区间" "难点：快节奏里保持高位明亮" "科普：高音遇到密集节奏，换气和咬字会一起变难。" "福茂唱片 / 寓言 Official MV"
render_overlay_segment "${ASSET_DIR}/04-yuyan.mp4" "04-yuyan" "${WORK_DIR}/segments/04-yuyan.mp4"

make_rank_overlay "05-aurora" "#f7f2e8" "TOP 5 / 经典高音" "欧若拉" "参考峰值：A5 附近" "难点：连续副歌 + 音色稳定" "科普：A5 不只是高，还要保持她标志性的清亮音色。" "福茂唱片 / 欧若拉 Official MV"
render_overlay_segment "${ASSET_DIR}/05-aurora.mp4" "05-aurora" "${WORK_DIR}/segments/05-aurora.mp4"

make_title_overlay "99-closing" "REFERENCE ONLY" "音高不是唯一标准" "难的是稳定唱出来" "后续可做：现场版逐句扒谱 / 原调与升降调对比。"
...
file '${WORK_DIR}/segments/01-adiao.mp4'
file '${WORK_DIR}/segments/02-butong.mp4'
file '${WORK_DIR}/segments/03-nahan.mp4'
file '${WORK_DIR}/segments/04-yuyan.mp4'
file '${WORK_DIR}/segments/05-aurora.mp4'
